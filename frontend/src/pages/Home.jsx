      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          <div className="card-hover p-6 cursor-pointer">
            ...
            {!showBotDifficulty ? (
              <button
                ...
                className="w-full py-2 rounded-xl text-sm font-semibold bg-gradient-to-r from-purple-600 to-violet-600 text-white transition-all hover:shadow-md hover:shadow-purple-500/15"
              >
                Choose Difficulty
              </button>
            ) : (
              <div className="flex flex-col gap-2 animate-fade-in">
                <button
                  ...
                  className="w-full py-2 rounded-xl text-sm font-semibold bg-emerald-500/10 text-emerald-400 hover:bg-emerald-500/20 transition-all"
                >
                  🟢 Easy
                </button>
                <button
                  onClick={() => navigate('/bot?difficulty=10')}
                  className="w-full py-2 rounded-xl text-sm font-semibold bg-amber-500/10 text-amber-400 hover:bg-amber-500/20 transition-all"
                >
                  🟡 Medium
                </button>
                <button
                  onClick={() => navigate('/bot?difficulty=15')}
                  className="w-full py-2 rounded-xl text-sm font-semibold bg-red-500/10 text-red-400 hover:bg-red-500/20 transition-all"
                >
                  🔴 Hard
                </button>
              </div>
          ...
          >
            ...
            <button className="w-full py-2 rounded-xl text-sm font-semibold bg-sky-500/10 text-sky-400 hover:bg-sky-500/20 transition-all">
              Play Puzzles
            </button>
          </div>
          ...
          >
            ...
            <button className="w-full py-2 rounded-xl text-sm font-semibold bg-gradient-to-r from-chess-green to-emerald-600 text-white transition-all hover:shadow-md hover:shadow-chess-green/15">
              View Contests
            </button>
          </div>
          ...
          >
            ...
            <button className="w-full py-2 rounded-xl text-sm font-semibold bg-amber-500/10 text-amber-400 hover:bg-amber-500/20 transition-all">
              See Schedule
            </button>
          </div>
        </div>
